...
class JuiceService: ObservableObject {
  @Published var stock: [Fruit: Int] = [.strawberry: 12,
                                        .apple: 3,
                                        .peach: 4,
                                        .watermelcon: 5,
                                        .banana: 6,
  ...
  @Published var juices: [Juice] = [Juice(name: "딸기 주스", recipe: Recipe(ingredient: [.strawberry: 10]), color: "strawberryPink"),
  ...
  init(stock: [Fruit: Int], juices: [Juice]) {
    self.stock = stock
    self.juices = juices
  }
